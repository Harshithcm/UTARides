...
public class WidgetActivity extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {
		...
		//Retrieving the email id from shared preferences
		...
		if (intent.getAction() == null) {
			...
			if (extras != null) {
				...
				try {
					...
					//checks if the user is a car owner or not
					...
					//to change the availability of the car owner upon click and also the image is changed	
